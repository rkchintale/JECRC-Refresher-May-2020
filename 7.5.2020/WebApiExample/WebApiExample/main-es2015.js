...
function EmployeesComponent_tr_16_Template(rf, ctx) { if (rf & 1) {
...
function EmployeesComponent_span_26_Template(rf, ctx) { if (rf & 1) {
...
function EmployeesComponent_span_33_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 19);
...
function EmployeesComponent_span_40_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 19);
...
EmployeesComponent.ɵfac = function EmployeesComponent_Factory(t) { return new (t || EmployeesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_employees_service__WEBPACK_IMPORTED_MODULE_2__["EmployeesService"])); };
EmployeesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EmployeesComponent, selectors: [["employees-comp"]], decls: 44, vars: 11, consts: [[1, "row"], [1, "col-lg-6"], [1, "mb-3"], [1, "table"], [1, "table-dark", "text-dark"], [4, "ngFor", "ngForOf"], [3, "formGroup"], [1, "border-bottom", "pb-2", "mb-2"], [1, "form-group", "form-row"], ["for", "empId", 1, "col-md-3", "col-form-label"], [1, "col-md-9"], ["type", "text", "placeholder", "Employee ID", "name", "empId", "formControlName", "EmpId", 1, "form-control", 3, "ngClass"], ["class", "text-danger", 4, "ngIf"], ["for", "empName", 1, "col-md-3", "col-form-label"], ["type", "text", "placeholder", "Employee Name", "name", "empName", "formControlName", "EmpName", 1, "form-control"], ["for", "email", 1, "col-md-3", "col-form-label"], ["type", "text", "placeholder", "Email", "name", "email", "formControlName", "Email", 1, "form-control"], [1, "text-center"], [1, "btn", "btn-success", 3, "click"], [1, "text-danger"]], template: function EmployeesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EmployeesComponent_Template_button_click_42_listener() { return ctx.onAddClick(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EmployeesComponent, [{
    ...
    }], function () { return [{ type: _employees_service__WEBPACK_IMPORTED_MODULE_2__["EmployeesService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! C:\jecrc\JECRC-Refresher-May-2020\7.5.2020\AngularDemo2\src\main.ts */"./src/main.ts");
